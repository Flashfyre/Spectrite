...
public class EntitySpectriteSkeleton extends EntitySkeleton implements ISpectriteMob, ISpectriteBipedMob {
	...
	protected void setEquipmentBasedOnDifficulty(DifficultyInstance difficulty)
    {
	    ...
	    this.setDropChance(EntityEquipmentSlot.MAINHAND, new Double(SpectriteModConfig.spectriteMobBowDropRate).floatValue() / (100f / chanceMultiplier));
		
		this.setItemStackToSlot(EntityEquipmentSlot.OFFHAND, new ItemStack(ModItems.spectrite_arrow, rand.nextInt(4) + 1));
		this.setDropChance(EntityEquipmentSlot.OFFHAND, new Double(SpectriteModConfig.spectriteMobArrowDropRate).floatValue() / (100f / chanceMultiplier));
