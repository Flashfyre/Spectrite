        ...
        if (this.world.isRemote)
        {
            ...
            if (flag)
            {
            	if (this.rand.nextBoolean())
                {
	                for (int i = 0; i < 2; ++i)
	                {
	                    ...
	                    SpectriteMod.Proxy.spawnSpectriteSpellParticle(this.world, this.posX + f3, this.posY, this.posZ + f4,
            ...
            else
            {
                ...
                for (int k1 = 0; k1 < f5; ++k1)
                {
                    ...
                    SpectriteMod.Proxy.spawnSpectriteSpellParticle(this.world, this.posX + f8, this.posY, this.posZ + f9,
                		colourRGB[0], colourRGB[1], colourRGB[2], invertColour);
                }
            }
        }
