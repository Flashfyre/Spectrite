package com.samuel.spectritemod.client.renderer.sky;
...
public class SpectriteSkyRenderer extends IRenderHandler {
	...
	private static final ResourceLocation SKY_TEXTURES = new ResourceLocation(SpectriteMod.MOD_ID, "textures/environment/spectrite_sky.png");
