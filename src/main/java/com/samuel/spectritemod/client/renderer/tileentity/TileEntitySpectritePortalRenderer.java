...
public class TileEntitySpectritePortalRenderer extends TileEntitySpecialRenderer<TileEntitySpectritePortal> {
	...
	private static final ResourceLocation SPECTRITE_SKY_TEXTURE = new ResourceLocation("spectritemod:textures/environment/spectrite_sky.png");
    ...
    @Override
    public void renderTileEntityAt(TileEntitySpectritePortal te, double x, double y, double z, float partialTicks, int destroyStage)
    {
        ...
        for (int j = 0; j < i; ++j)
        {
            ...
            {
                vertexbuffer.pos(x, y + f, z + 1.0D).color(f3, f4, f5, 1.0F).endVertex();
                vertexbuffer.pos(x + 1.0D, y + f, z + 1.0D).color(f3, f4, f5, 1.0F).endVertex();
                vertexbuffer.pos(x + 1.0D, y + f, z).color(f3, f4, f5, 1.0F).endVertex();
                vertexbuffer.pos(x, y + f, z).color(f3, f4, f5, 1.0F).endVertex();
            }
