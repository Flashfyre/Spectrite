...
public class RenderSpectriteFireball extends Render<EntitySpectriteFireball> {

	private final float scale;
	
	public RenderSpectriteFireball(RenderManager renderManagerIn)
    {
        super(renderManagerIn);
        this.scale = 0.3125F;
    }

    public RenderSpectriteFireball(RenderManager renderManagerIn, float scaleIn)
    {
        super(renderManagerIn);
        this.scale = scaleIn;
    }
     ...
     */
    @Override
    public void doRender(EntitySpectriteFireball entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    @Override
    protected ResourceLocation getEntityTexture(EntitySpectriteFireball entity)
    {
