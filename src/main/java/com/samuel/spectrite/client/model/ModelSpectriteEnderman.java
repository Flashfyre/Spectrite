...
public class ModelSpectriteEnderman extends ModelBiped
{
    ...
    public ModelSpectriteEnderman(float scale)
    {
        super(0.0F, -14.0F, 64, 64);
        this.bipedHead = new ModelRenderer(this, 0, this.isAttacking ? 0 : 32);
        this.bipedHead.addBox(-4.0F, -8.0F, -4.0F, 8, 8, 8, 0.0F);
        this.bipedHead.setRotationPoint(0.0F, -14.0F, 0.0F);
        this.bipedHeadwear = new ModelRenderer(this, 0, this.isAttacking ? 16 : 48);
