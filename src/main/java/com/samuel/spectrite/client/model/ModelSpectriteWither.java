...
public class ModelSpectriteWither extends ModelBase
{
    private final ModelRenderer[] upperBodyParts;
    private final ModelRenderer[] heads;

    public ModelSpectriteWither(float p_i46302_1_)
    {
        ...
        this.upperBodyParts[1].setTextureOffset(24, 26).addBox(-4.0F, 4.0F, 0.5F, 11, 2, 2, p_i46302_1_);
        this.upperBodyParts[1].setTextureOffset(24, 30).addBox(-4.0F, 6.5F, 0.5F, 11, 2, 2, p_i46302_1_);
    ...
    {
        EntitySpectriteWither entitySpectriteWither = (EntitySpectriteWither)entityLivingBaseIn;

        for (int i = 1; i < 3; ++i)
        {
            this.heads[i].rotateAngleY = (entitySpectriteWither.getHeadYRotation(i - 1) - entityLivingBaseIn.renderYawOffset) * 0.017453292F;
            this.heads[i].rotateAngleX = entitySpectriteWither.getHeadXRotation(i - 1) * 0.017453292F;
        }
    }
}