...
public class EntitySpectriteArrow extends EntityArrow {
	...
	protected void onHit(RayTraceResult raytraceResultIn)
    {
		if (!world.isRemote) {
			...
			if (SpectriteConfig.spectriteArrowDamageMode != SpectriteConfig.EnumSpectriteArrowDamageMode.SPECTRITE_DAMAGE) {
			...
			try {
				if (power == 1) {
					...
					if (SpectriteConfig.spectriteArrowDamageMode != SpectriteConfig.EnumSpectriteArrowDamageMode.SPECTRITE_DAMAGE_EXPLOSION) {
