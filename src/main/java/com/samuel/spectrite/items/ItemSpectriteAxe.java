...
public class ItemSpectriteAxe extends ItemAxe implements ISpectriteTool, ISpectriteCustomTooltipItem {
	
	public ItemSpectriteAxe(ToolMaterial material) {
        super(material, material == Spectrite.SPECTRITE_TOOL ? 11.0F : 15.0F, -3.0f);
	...
	{
		return state.getBlock() instanceof BlockBreakable ? this.efficiency : super.getDestroySpeed(stack, state);
	}
